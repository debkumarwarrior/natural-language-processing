...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #### YOUR CODE HERE ####
        ########################
        self.stackoverflow_bot = ChatBot('Nim Obvious', trainer='chatterbot.trainers.ChatterBotCorpusTrainer')
        self.stackoverflow_bot.train("chatterbot.corpus.english")
    ...
    def generate_answer(self, question):
        ...
        if intent == 'dialogue':
            ...
            response = self.stackoverflow_bot.get_response(question) #### YOUR CODE HERE ####
            return response
